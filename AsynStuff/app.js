...
//promesaUno.then((respuesta) => {console.log(respuesta);promesaDos.then((respuesta2) => {console.log(respuesta2);promesaTres.then((respuesta3)=>{console.log(respuesta3)}).catch((error) => {console.log(error)})})})
